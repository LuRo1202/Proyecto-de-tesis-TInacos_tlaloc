...
<head>
    ...
    <title>Editar Oferta - Gerente</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('gerente.ofertas.update', $oferta->id) }}" id="formOferta">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4 mt-2">
                        <div class="col-md-6">
                            ...
                            <input type="date" name="fecha_inicio" class="form-control @error('fecha_inicio') is-invalid @enderror" 
                                   value="{{ old('fecha_inicio', $oferta->fecha_inicio instanceof \Carbon\Carbon ? $oferta->fecha_inicio->format('Y-m-d') : \Carbon\Carbon::parse($oferta->fecha_inicio)->format('Y-m-d')) }}" required>
                            @error('fecha_inicio')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="fecha_fin" class="form-control @error('fecha_fin') is-invalid @enderror" 
                                   value="{{ old('fecha_fin', $oferta->fecha_fin instanceof \Carbon\Carbon ? $oferta->fecha_fin->format('Y-m-d') : \Carbon\Carbon::parse($oferta->fecha_fin)->format('Y-m-d')) }}" required>
                            @error('fecha_fin')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
