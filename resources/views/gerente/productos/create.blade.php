...
<head>
    ...
    <style>
        ...
        @media (max-width: 576px) {
            ...
            .btn-custom { width: 100%; justify-content: center; }
            .form-actions > div .btn-custom { width: 100%; justify-content: center; }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="mt-3 p-2 bg-info bg-opacity-10 rounded">
                                ...
                                <span class="small">
                                    <strong>¿Necesitas más colores?</strong> Contacta al administrador para agregar nuevos colores al sistema.
                                </span>
                            </div>
                        </div>
                    </div>
