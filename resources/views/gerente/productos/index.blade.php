...
<head>
    ...
    <title>Gestión de Productos - Sucursal {{ session('sucursal_nombre') }}</title>
    ...
    <div class="main-content">
        <div class="header-bar">
            ...
            <div class="header-actions">
                ...
                <a href="{{ route('gerente.productos.nuevo') }}" class="btn-custom btn-success-custom">
                    <i class="fas fa-plus"></i> Nuevo Producto
                </a>
                @if(request()->has('categoria') || request()->has('busqueda') || request()->has('stock_bajo'))
        ...
        <div class="alert-stock">
            ...
            <div class="flex-grow-1">
                ...
                <div class="small">
                    Tienes <strong>{{ $productos_bajos }} producto(s)</strong> con inventario bajo en tu sucursal.
                    <a href="{{ route('gerente.productos', ['stock_bajo' => 1]) }}" class="text-primary text-decoration-none ms-1">
        ...
        <div class="filter-card">
            ...
            <form method="GET" action="{{ route('gerente.productos') }}" class="row g-2">
                ...
                <div class="col-md-2 col-sm-6">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn-action" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark));">
                            <i class="fas fa-search"></i>
                        </button>
                        <a href="{{ route('gerente.productos') }}" class="btn-action" style="background: linear-gradient(135deg, var(--secondary), #6c757d);">
                ...
                <div class="col-12 mt-2">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-muted small">
                            ...
                            Mostrando <strong>{{ $total_productos }}</strong> productos de tu sucursal
                        </div>
                    </div>
                </div>
            </form>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 d-flex align-items-center gap-2">
                    <i class="fas fa-list-ol"></i> Productos en {{ session('sucursal_nombre') }}
                    <span class="badge bg-primary">{{ $productos->count() }}</span>
                </h5>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            @endphp
                            <tr onclick="window.location.href='{{ route('gerente.productos.editar', $producto->id) }}';">
                                <td>
                                    <div class="producto-img">
                                        @if($imagen_existe)
                                            <img src="{{ asset('assets/img/productos/' . $producto->codigo . '.jpg') }}" 
                                                 alt="{{ $producto->nombre }}">
                                        @else
                                            <i class="fas fa-box"></i>
                                        @endif
                                ...
                                <td>
                                    <div class="action-buttons" onclick="event.stopPropagation();">
                                        <a href="{{ route('gerente.productos.editar', $producto->id) }}" 
                            ...
                            <tr>
                                <td colspan="8" class="empty-state">
                                    ...
                                    <p>{{ request()->has('categoria') || request()->has('busqueda') || request()->has('stock_bajo') ? 
                                        'No hay productos que coincidan con los filtros aplicados en tu sucursal.' : 
                                        'Aún no hay productos registrados en esta sucursal.' }}</p>
                                    <a href="{{ route('gerente.productos.nuevo') }}" class="btn-custom btn-primary-custom mt-2">
            ...
            <div class="card-footer">
                <nav aria-label="Paginación">
                    <ul class="pagination pagination-custom justify-content-center mb-0">
                        @if($pagina > 1)
                        <li class="page-item">
                            <a class="page-link" href="{{ route('gerente.productos', array_merge(request()->query(), ['pagina' => $pagina-1])) }}">
                        ...
                        @for($i = max(1, $pagina - 2); $i <= min($total_paginas, $pagina + 2); $i++)
                            ...
                            @else
                            <li class="page-item">
                                <a class="page-link" href="{{ route('gerente.productos', array_merge(request()->query(), ['pagina' => $i])) }}">
                                    {{ $i }}
                                </a>
                            </li>
                            @endif
    ...
    <script>
        function confirmarEliminar(id, nombre) {
            ...
            Swal.fire({
                ...
                html: `¿Estás seguro de eliminar permanentemente el producto <strong>"${nombre}"</strong> de esta sucursal?<br><small class="text-danger">Esta acción NO se puede deshacer.</small>`,
                icon: 'warning',
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const hasFilters = urlParams.has('categoria') || urlParams.has('busqueda') || urlParams.has('stock_bajo');
            ...
            @if($productos->count() === 0 && (request()->has('categoria') || request()->has('busqueda') || request()->has('stock_bajo')))
            setTimeout(() => {
                Swal.fire({
                    title: 'Sin Resultados',
                    html: 'No se encontraron productos con los filtros aplicados en tu sucursal.',
                    icon: 'warning',
