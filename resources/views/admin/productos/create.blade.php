        ...
        <form method="POST" action="{{ route('admin.pedidos.store') }}" id="form-pedido">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <!-- DEBUG: Mostrar ID de sucursal actual -->
                    <div style="background: yellow; padding: 5px; margin: 5px 0; font-size: 12px;">
                        DEBUG - Sucursal ID en badge: <span id="debug-sucursal-id">{{ $sucursalActual->id }}</span>
                        <br>Nombre: <span id="debug-sucursal-nombre">{{ $sucursalActual->nombre }}</span>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('cliente_nombre') is-invalid @enderror" 
                                       ...
                                       placeholder="Ej: Juan Pérez" value="{{ old('cliente_nombre') }}">
